...
- [MicroCode](https://microsoft.github.io/microcode/) - MicroCode is a icon-based (minimal text), computer friendly editor for the micro:bit V2 - can also program on an Arcade Shield with the correct hex code. It is suitable for younger learners and users with variable accessibility needs. (https://microsoft.github.io/microcode/docs/manual).
