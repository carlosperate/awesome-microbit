...
- [Eine Einführung in die Informatik](https://github.com/stritti/girlsday-einfuehrung-informatik) German Open Source presentation based on impress.js to teach within one day girls how to program using micro:bit (GirlsDay)
