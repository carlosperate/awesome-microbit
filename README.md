...
- [PiicoDev Adapter](https://github.com/CoreElectronics/CE-PiicoDev-Adapter-for-Microbit) - Kicad files for a an adapter to experiment with sensors from the PiicoDev range.
