...
- [CBMicroBit](https://github.com/Louismac/CBMicroBit) - CoreBluetooth wrapper that connects a micro:bit to a computer running OSX using BLE and outputs over OSC (standalone, C++ and Objective C libraries).
