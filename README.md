...
- [eBlock](https://github.com/distintiva/eBlock) - A Scratch based application to visually code BBC micro:bit and other devices with meny cool features
...
- [Distintiva micro:bit library](https://github.com/distintiva/distintiva_microbit_lib) - An Arduino library to code micro:bit using Arduino IDE or Arduino-cli
