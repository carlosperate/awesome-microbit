...
- [Escape Room micro:bit - Magic Tune](https://microbit.hackster.io/VBB/escape-room-micro-bit-1-magic-tune-0f8552) - Code the micro:bit to play the magic tune exactly as the forest fairy demands to make your escape.
