...
- [Get started with BBC micro:bit - the next gen](https://microbit.org/teach/events/#get-started-with-bbc-micro:bit---the-next-gen-%28uk-only%29) - Webinar on the 14th of September to introduce UK teachers to the micro:bit and share the "BBC micro:bit - the next gen" campaign.
