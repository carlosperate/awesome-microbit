...
class TestCommitTweet(unittest.TestCase):
    ...
    def test_commit_1(self):
        """Normal commit."""
        title, url, description = entry_point.get_commit_list_entry('f219e79ff490f784d8a6bb8807149034dded68a8')
        tweet = entry_point.format_tweet_msg(title, url, description)
    ...
    def test_commit_2(self):
        """Merge commit."""
        title, url, description = entry_point.get_commit_list_entry('401d6c4ee70d21dd86631eb377433b319cbb88d1')
        tweet = entry_point.format_tweet_msg(title, url, description)
    ...
    def test_commit_3(self):
        ...
        title, url, description = entry_point.get_commit_list_entry('4b661cf6bdeb22a56721bc5955eb554c736eca8c')
        tweet = entry_point.format_tweet_msg(title, url, description)
    ...
    def test_commit_4(self):
        ...
        with self.assertRaises(Exception) as context:
            title, url, description = entry_point.get_commit_list_entry('fa544e2c211eb47ac1cb287df5f5c09edabb2ae0')
    ...
    def test_commit_5(self):
        ...
        title, url, description = entry_point.get_commit_list_entry('8a570813f0cfb3a9ebbcd9f8006e0eb8c6f11799')
        tweet = entry_point.format_tweet_msg(title, url, description)
    ...
    def test_commit_6(self):
        ...
        title, url, description = entry_point.get_commit_list_entry('5652ef8bf0d617a3d4085429f4d39007b44ef09d')
        tweet = entry_point.format_tweet_msg(title, url, description)
