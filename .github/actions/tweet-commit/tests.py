...
class TestCommitTweet(unittest.TestCase):
    ...
    def test_commit_1(self):
        """Normal commit."""
        entries = tweet_commit.get_commit_list_entries("2c58c69cd5ea09fe15726d60c40faaccc6735921")
    ...
    def test_commit_2(self):
        """Merge commit."""
        entries = tweet_commit.get_commit_list_entries("401d6c4ee70d21dd86631eb377433b319cbb88d1")
        tweet = tweet_commit.format_tweet_msg(entries[0]["title"], entries[0]["url"], entries[0]["description"])
    ...
    def test_commit_3(self):
        ...
        entries = tweet_commit.get_commit_list_entries("2faac881c36435b45a454989ca915f50fe919c94")
        tweet = tweet_commit.format_tweet_msg(entries[0]["title"], entries[0]["url"], entries[0]["description"])
    ...
    def test_commit_5(self):
        ...
        entries = tweet_commit.get_commit_list_entries("d8eaa108e6fbb635f282f341e64b7b36507f0788")
        tweet = tweet_commit.format_tweet_msg(entries[0]["title"], entries[0]["url"], entries[0]["description"])
    ...
    def test_commit_6(self):
        ...
        entries = tweet_commit.get_commit_list_entries("5652ef8bf0d617a3d4085429f4d39007b44ef09d")
        tweet = tweet_commit.format_tweet_msg(entries[0]["title"], entries[0]["url"], entries[0]["description"])
    ...
    def test_invalid_no_description(self):
        ...
        with self.assertRaises(Exception) as context:
            entries = tweet_commit.get_commit_list_entries("fa544e2c211eb47ac1cb287df5f5c09edabb2ae0")
    ...
    def test_multiple_entries(self):
        ...
        entries = tweet_commit.get_commit_list_entries("749861108e6f65751c4ec0927ef40d495e56dad5")
        tweet_0 = tweet_commit.format_tweet_msg(entries[0]["title"], entries[0]["url"], entries[0]["description"])
        tweet_1 = tweet_commit.format_tweet_msg(entries[1]["title"], entries[1]["url"], entries[1]["description"])
